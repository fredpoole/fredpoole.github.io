...
head(df_long,n=10)
```
We will use this data set later on when doing more advance visualization techniques. 
</br>
<hr>
<hr>

#Running Descriptives
In this section we will go over how to run descriptives on a data set. We will look at some base packages that allow you to automatically run descriptives on all of your variables and then we'll look at some other quick tools that allow you to explore your data with more precision. 
</br>
</br>
